        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                  <form class="form-horizontal row-fluid" action="allstudents.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from student_table where uname='$s' or uname like '%$s%'";
                                        }
                                    else
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><b><?php echo $mno ?></b></td>
                                        <td><center>
                                            <a href="asdetailsview.php?id=<?php echo $uname; ?>" class="btn btn-primary">All Details</a><br><br>
                                            <a href="asdetailsedit.php?id=<?php echo $uname; ?>" class="btn btn-success">Edit</a><br><br>
                                            <a href="asdelete.php?id=<?php echo $uname; ?>" class="btn btn-danger">Delete</a>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
                               </tbody>
