        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                  <form class="form-horizontal row-fluid" action="lstudentdetails.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Search"><b>Search:</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Roll No" class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from student_table where uname='$s' and counid='$user_id' or uname like '%$s%' and counid='$user_id'";
                                        }
                                    else
                                        $sql="select * from student_table where counid='$user_id'";
                        ...
                        <table class="table" id = "tables">
                            ...
                            ?>
                                    <tr>
                                    <td><img class="card-img-top" src="student_img/<?php echo $img ?>" style="height:200px;width:170px;"alt="Card image cap"></td>
                                      <td><?php echo $uname ?></td>
                                      <td><?php echo $fname;echo $lname ?></td>
                                      <td><b><?php echo $email ?></b></td>
                                      <td><b><?php echo $mno ?></b></td>
                                        <td><center>
                                            <a href="lsdetailsview.php?id=<?php echo $uname; ?>" class="btn btn-primary">All Details</a>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
                               </tbody>
