                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addadmin.php" method="post" enctype="multipart/form-data">
                                        <div class="control-group">
                                            <label class="control-label" ><b>Admin ID</b></label>
                                            <div class="controls">
                                                <input type="text" name="uname" placeholder="Admin ID" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
if(isset($_POST['submit']))
{
    ...
    $folder = "admin_img/".$filename;
$sql1="insert into admin_table (uname,pwd,fname,lname,image) values ('$uname','$pwd','$fname','$lname','$filename')";
