        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                  <form class="form-horizontal row-fluid" action="lweeklyreports.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from weekly_report where rollno='$s' and counid='$user_id' or rollno like '%$s%' and counid='$user_id'";
                                        }
                                    else
                                        $sql="select * from weekly_report where counid='$user_id'";
