                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="seprofile.php?id=<?php echo $user_id ?>" method="post" enctype="multipart/form-data">
                                <div class="control-group">
                                            <div class="controls"> 
                                            <img class="card-img-top" src="student_img/<?php echo $img ?>" alt="Card image cap" style="height: 170px;width:150px;border-radius:50%;">
                                            </div>
                                        </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="email" name="email" value= "<?php echo $email?>" class="span8" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><b>Address:</b></label>
                                        <div class="controls">
                                            <input type="text" name="adrs" value= "<?php echo $adrs?>" class="span8" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
...
$sql1="update student_table set email='$email',adrs='$adrs', pwd='$pwd' where id='$user_id'";
if($conn->query($sql1) === TRUE){
   $update_image = $_FILES['update_image']['name'];
   $update_image_size = $_FILES['update_image']['size'];
   $update_image_tmp_name = $_FILES['update_image']['tmp_name'];
   $update_image_folder = 'student_img/'.$update_image;
   if(!empty($update_image)){
      if($update_image_size > 2000000){
        echo "<script type='text/javascript'>alert('Image Size is too Large')</script>";
      }else{
         $image_update_query = "update student_table set stuimg='$update_image' where id='$user_id'";
